...
4. **Tinted Jelly Balm 3D Case Colors:** Tinted Jelly Balm includes 3 case colors (`Fizzy Pop`, `Sweetie Pop`, `Cherry Pop`), expanding cross-bundle sheets (e.g. $6 \times 6 \times 3 = 108$ rows for OTG & TJB).
