...
scope) contract: full-grid left tables (181 / 181 / 690 / 690 rows), unsold
...
completeness, and number masks. The Produk 2 grid pairs the six Bundling
Silang colour families only (15 groups); Lipcare never appears in a cross
group.
"""
...
_GRID_SIZES = {"produk": 181, "produk2": 690}
...
def test_produk2_group9_is_36_rows_not_72(grids):
    ...
    assert len(g9_rows) == 36  # Swipe To Glow (6) x Over The Glaze (6)
